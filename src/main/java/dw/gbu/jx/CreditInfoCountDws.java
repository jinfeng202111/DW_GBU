...
public class CreditInfoCountDws {
    private static final String topic_dws_credit_info = "dws-credit-info";
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "dws-credit-group1");
        //kafka分区自动发现周期
        ...
        FlinkKafkaConsumer011<ObjectNode> kafkaConsumer011 = new FlinkKafkaConsumer011<>(topic_dws_credit_info, new JSONKeyValueDeserializationSchema(true), props);
        ...
        //数据插入到dws层的hbase表，并执行汇总操作
        streamSource.addSink(new DwsCreditInfoCountToHbase()).name("CreditInfoCountDwsHbase");

        //触发执行
        env.execute(CreditInfoCountDws.class.getName());
    }
}
